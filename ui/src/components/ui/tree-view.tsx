...
type TreeProps = React.HTMLAttributes<HTMLDivElement> & {
  ...
  handleSelectedItemIdChange?: (selectedItemId: string | undefined) => void;
};
...
const TreeView = React.forwardRef<HTMLDivElement, TreeProps>(
  (
    ...
    const handleSelectChange = React.useCallback(
      ...
      [onSelectChange, handleSelectedItemIdChange],
    );
  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          'ml-5 flex text-left items-center py-1.5 cursor-pointer before:right-1',
          treeVariants(),
          className,
          selectedItemId === item.id && selectedTreeVariants(),
        )}
